...
# Make an instance and call increment_login_attempts()
print("\nGoing to try logging in three times...")
isiah_scott.increment_login_attempts()
isiah_scott.increment_login_attempts()
isiah_scott.increment_login_attempts()
print(f"You have tried to login {isiah_scott.login_attempts} times.")

# Call reset_login_attempts() method to reset the attempts back to 0.
print("\nResetting attempts to login...")
isiah_scott.reset_login_attempts()
print(f"Login attempts: {isiah_scott.login_attempts}")
